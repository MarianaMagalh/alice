        ...
        <main className='bodySobreNos'>
            ...
            <div className='sobreNosContainer'>
                ...
                <section className='sobreNosSection'>
                    <h2>Sobre Nós</h2>
                    <p>
                        Bem-vindo ao nosso cantinho mágico de leitura, um
                        lugar onde a curiosidade é a chave e a imaginação
                        não tem limites. Nascemos de um sonho, assim como o
                        de Alice, de criar um espaço onde as histórias ganham
                        vida e cada livro é um convite para uma nova
                        aventura.
                    </p>
                    <p>
                        Nossa missão é simples: inspirar o amor pela leitura,
                        oferecendo um refúgio da realidade onde cada página
                        virada é um passo mais fundo na toca do coelho.
                        Acreditamos no poder das palavras para transformar,
                        encantar e nos fazer questionar o impossível.
                    </p>
                </section>
